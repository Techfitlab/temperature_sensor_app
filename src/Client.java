...
public class Client {
    ...
    protected String getStats() {
    	String theDateCommand = "GetStats", timeAndTemperature;
    	System.out.println("01. -> Sending Command (" + theDateCommand + ") to the server...");
    	this.send(theDateCommand);
    	try{
    		timeAndTemperature = (String) receive();
    		System.out.println("05. <- The Server responded with: ");
    		System.out.println("    <- " + timeAndTemperature);
    		return timeAndTemperature;
    	}
    	catch (Exception e){
    ...
    {
    	System.out.println("**. Java Client Application - temperature_sensor_app OOP Module, DCU");
    	if(args.length==1){
